...
constexpr size_t MAX_COLORS = 1 << (sizeof(ColorIndex) * 8);
...
public:
    ...
    static bool write_image(const std::string& filename, const std::vector<unsigned char>& image, int width, int height);
